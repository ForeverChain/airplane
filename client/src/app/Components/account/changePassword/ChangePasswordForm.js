            ...
            <div className="kt-section kt-section--first">
              <div className="kt-section__body">
                ...
                <div className="form-group row">
                  ...
                  <div className="col-lg-9 col-xl-6">
                    <Field type="password" className="form-control" name='oldPassword' placeholder="Одоогийн нууц үг"/>
                ...
                <div className="form-group row">
                  ...
                  <div className="col-lg-9 col-xl-6">
                    <Field type="password" className="form-control" name="newPassword" placeholder="Шинэ нууц үг"/>
                ...
                <div className="form-group form-group-last row">
                  ...
                  <div className="col-lg-9 col-xl-6">
                    <Field type="password" className="form-control" name="confirmPassword" placeholder="Баталгаажуулах"/>
