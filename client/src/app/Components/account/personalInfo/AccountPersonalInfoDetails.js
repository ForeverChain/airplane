          ...
          <div className="kt-section__body">
            ...
            {!edit ? (
              <div className="row">
                ...
                <div className="form-group col-6">
                  <div className="form-label">Хаяг</div>
                  <h5>{user.address || "Оруулаагүй байна"}</h5>
                </div>
                <div className="form-group col-6">
                  <div className="form-label">Улс</div>
                  <h5>{user.country || "Оруулаагүй байна"}</h5>
                </div>
                <div className="form-group col-6">
                  <div className="form-label">Пасспорт дугаар</div>
                  <h5>{user.passportNo || "Оруулаагүй байна"}</h5>
                </div>
              </div>
            ) : (
              <div className="row">
