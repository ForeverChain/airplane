            ...
            <div className="kt-widget__body">
              <div className="kt-widget__content">
                <div className="kt-widget__info">
                  <span className="kt-widget__label">Имэйл:</span>
                  <span className="kt-widget__data">{user.email}</span>
                </div>
                <div className="kt-widget__info">
                  <span className="kt-widget__label">Утас:</span>
                  <span className="kt-widget__data">{user.mobileNo}</span>
                </div>
                <div className="kt-widget__info">
                  <span className="kt-widget__label">Хаяг:</span>
              ...
              <div className="kt-widget__items">
                ...
                >
                  <span className="kt-widget__section">
                    ...
                    <span className="kt-widget__desc">Нууц үгээ өөрчлөх</span>
                  </span>
                </span>
              </div>
            </div>
