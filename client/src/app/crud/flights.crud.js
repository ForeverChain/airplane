...
export const GET_USER_TRIPS = "/api/ticket";
export const GET_ALL_TRIPS = "/api/flights/all-trips";
export const ADD_FLIGHT = "/api/flights/add";
export const DELTE_FLIGHT = "/api/flights/delete";
export const BOOK_FLIGHT = "/api/ticket";
...
export function bookFlight({ details, flightId, userId, totalPrice}) {
  return axios.post(BOOK_FLIGHT, { details, flightId, userId, totalPrice  });
}
...
export function addFlight(data) {
  return axios.post(ADD_FLIGHT, data);
}

export function removeFlight(adminId) {
  return axios.put(DELTE_FLIGHT, {adminId});
}
